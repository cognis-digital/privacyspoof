#!/usr/bin/env sh
# Universal installer for privacyspoof. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/privacyspoof.git"
echo "Installing privacyspoof ..."
...
echo "Done. Run: privacyspoof --help"
